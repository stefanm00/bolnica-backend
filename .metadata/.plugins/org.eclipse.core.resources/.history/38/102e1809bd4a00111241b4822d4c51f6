...
class ArtiklControllerTest {
    ...
    String apiUrl() {
        return "http://localhost:" + port + "/artikl";
    }
    ...
    void createArtikl() {
        ...
        HttpEntity<Artikl> entity = new HttpEntity<>(a);

        ResponseEntity<Artikl> response =
                template.exchange(apiUrl(), HttpMethod.POST, entity, Artikl.class);
    ...
    void getOne() {
        ResponseEntity<Artikl> response =
                template.getForEntity(apiUrl() + "/" + newId, Artikl.class);
